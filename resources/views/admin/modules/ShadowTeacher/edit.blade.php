            ...
            <div class="row justify-content-start">
                <div class="col-md-4 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('shadowteacher.attach', ['shadowteacher' => $shadowteacher]) }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" name="name" id="exampleFormControlInput1"
                                        placeholder="name@example.com" value="{{ $shadowteacher->name }}">
                                </div>
                                <button type="submit" class="btn btn-primary mt-3">ATTACH</button>
                            </form>
                        </div>
                    </div>
