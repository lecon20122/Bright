                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <input id="username" value="{{ old('name', auth()->user()->name) }}"
                                            name="name" placeholder="Username" class="form-control here" type="text">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <form method="POST" action="{{ route('postUpdateUser', ['user' => auth()->user()]) }}">
                                        ...
                                        <div class="form-group row my-2">
                                            ...
                                            <div class="col-8">
                                                <input id="username" value="{{ old('address', auth()->user()->address) }}"
                                                    name="address" placeholder="Username" class="form-control here"
                                                    type="text">
                                            </div>
                                        </div>
                                ...
                                @endif --}}
                                        @if (auth()->user()->type != App\Enums\DataBaseEnum::PATIENT)
                                            <div class="form-group row my-2">
                                                ...
                                                <div class="col-8">
                                                    <input id="email"
                                                        value="{{ old('price', auth()->user()->price) }}" name="price"
                                                        placeholder="price" class="form-control here" type="text">
                                                </div>
                                            </div>
                                        @endif
                                        @if (auth()->user()->type != App\Enums\DataBaseEnum::PATIENT)
                                            @if (auth()->user()->type != App\Enums\DataBaseEnum::SHADOW_TEACHER)
                                                @if (auth()->user()->type != App\Enums\DataBaseEnum::CENTER)
                                                    <div class="form-group row my-2">
                                                        <label for="email" class="col-4 col-form-label">Wait time</label>
                                                        <div class="col-8">
                                                            <input id="email"
                                                                value="{{ old('wait_time', auth()->user()->wait_time) }}"
                                                                name="wait_time" placeholder="wait time"
                                                                class="form-control here" type="text">
                                                        </div>
                                                    </div>
                                                @endif
